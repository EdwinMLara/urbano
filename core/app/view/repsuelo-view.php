	...
	<div class="col-md-12">
		<div class="box">
			<div class="box-header">
				<h1 class="box-title">Reporte de Uso de Suelo</h1>
			</div>
			<div class="box-body">
				<form>
					<input type="hidden" name="view" value="repsuelo">
					<div class="row">
						<div class="col-md-3">
								...
								?>
									<div class="col-md-3">
										...
										<ul class="dropdown-menu" role="menu">
											<li><a href="report/repusosuelo.php?sd=<?php echo $_GET["sd"];?>&ed=<?php echo $_GET["ed"];?>"><i class="fa fa-file-pdf-o"></i> PDF</a></li>
										</ul>
									</div>
									<br>
									<br>
